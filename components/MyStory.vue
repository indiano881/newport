...
import CertificationsC from './CertificationsC.vue';
...
<template>
  ...
  />
      ...
      <ul class="list-disc list-inside space-y-2 mb-6 text-lg text-black">
        <li><strong>Frontend Development:</strong> HTML, CSS, JavaScript, TypeScript, Vue, Nuxt, React, Next.js</li>
        <li><strong>Backend & APIs:</strong> Node.js, Express, REST, Supabase, MongoDB, MySQL, DynamoDB</li>
      ...
      <p class="mb-6 text-lg leading-relaxed text-black">
        I love building tools and platforms that people actually enjoy using. Whether I’m working on a solo project or collaborating in a team, I believe in shipping fast, learning constantly, and improving iteratively. I bring strong communication skills, a growth mindset, and a lot of energy to the table.
      </p>
