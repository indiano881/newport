export const projects = [
  ...
  },
  {
    ...
    content:
      'A real-world project developed in collaboration with Agile and UI/UX design students. Parking Time was built with the help of three other frontend developers, and we had weekly presentations with the client. What is the best features? Internationalization with next-intl, cool animations, and fetching external data with Sanity and Groq!',
  ...
  },
  {
    ...
    content:
      'This is a simple next.js project in which you can log in with username Davide and explore a group of different exclusive products, fetched from an external API. With the use of useContext is possible to save the itmes in your wishlist.',
