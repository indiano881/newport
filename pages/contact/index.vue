...
<template>
  ...
  >
    ...
    <div class="w-full max-w-lg mb-10 flex flex-col items-center">
      <p class="text-gray-600 mb-4 text-center">
        Want to talk? Book a free 15-minute intro call.
      </p>
      <a
    ...
    <p class="text-gray-600 mb-4">Or send me a message</p>
